...
public class MainActivity extends AppCompatActivity implements GreenAdapter.ListItemClickListener {
    ...
    private Toast mToast; // TODO (9) Create a Toast variable called mToast to store the current Toast
    ...
    public void onListItemClick(int clickedItemIndex) {
        ...
        String itemClicked = "Item #"+clickedItemIndex+" clicked.";
        mToast = Toast.makeText(this,itemClicked,Toast.LENGTH_LONG);
        mToast.show();
