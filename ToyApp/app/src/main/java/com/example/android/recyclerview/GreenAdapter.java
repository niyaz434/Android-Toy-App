...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    final private  ListItemClickListener mOnClickListener; // TODO (3) Create a final private ListItemClickListener called mOnClickListener
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public NumberViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(this);// TODO (7) Call setOnClickListener on the View passed into the constructor (use 'this' as the OnClickListener)
        }
