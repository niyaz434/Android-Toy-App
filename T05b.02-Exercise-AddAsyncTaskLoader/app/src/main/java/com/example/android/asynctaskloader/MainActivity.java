...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GIT_HUB_SEARCH_LOADER =22;// TODO (2) Create a constant int to uniquely identify your loader. Call it GITHUB_SEARCH_LOADER
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(GIT_HUB_SEARCH_LOADER, null, this);
    }
    ...
    private void makeGithubSearchQuery() {
        ...
        Loader<String> githubSearchLoader = loaderManager.getLoader(GIT_HUB_SEARCH_LOADER);
        // COMPLETED (23) If the Loader was null, initialize it. Else, restart it.
        if (githubSearchLoader == null) {
            loaderManager.initLoader(GIT_HUB_SEARCH_LOADER, queryBundle, this);
        } else {
            loaderManager.restartLoader(GIT_HUB_SEARCH_LOADER, queryBundle, this);
        }
