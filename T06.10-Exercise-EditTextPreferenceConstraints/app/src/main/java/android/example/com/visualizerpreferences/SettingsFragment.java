...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        preference.setOnPreferenceChangeListener(this);// TODO (3) Add the OnPreferenceChangeListener specifically to the EditTextPreference
    }
    ...
    Toast error = Toast.makeText(getContext(),"Please enter the number between 0.5 to 3",Toast.LENGTH_SHORT);
